...
class RestaurantsAdapter(val context: Context, val restaurants: List<YelpRestaurant>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {//建一個R.layout.item_restaurant來顯示recyclerview
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.bind(restaurant)//bind資料與viewholder 
